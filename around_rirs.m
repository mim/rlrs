...
%
% Simulate impulse responses for sources coming from different
% azimuths and elevations around a stationary listener.  Sources
% are jiggled around the position they are supposed to be in with
% gaussian noise.
%
% Options:
